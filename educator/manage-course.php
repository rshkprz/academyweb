					...
					if ($count>0) 
					{
						...
						while ($row = mysqli_fetch_assoc($res)) 
						{
							...
							<td><?php echo $active; ?></td>
								...
								<td>
									<a href="add-lesson.php?id=<?php echo $id; ?>" class="btn-primary">Add lessons</a> 
									<a href="update-course.php?id=<?php echo $id; ?>" class="btn-secondary">Update Course</a> 
									<a href="delete-course.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-danger">Delete Course</a>
								</td>
							</tr>
